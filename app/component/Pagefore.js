...
const gridItems = [
  ...
  <defs>
    ...
    },
    {
        ...
        svg: (
            <svg xmlns="http://www.w3.org/2000/svg" className="w-[24px] sm:w-[32px] md:w-[36px] lg:w-[40px] xl:w-[48px] 2xl:w-[50px]" viewBox="0 0 50 50" fill="none">
  <path d="M45.1485 8.42453C44.9395 8.19655 44.645 8.05404 44.341 8.03508C44.227 8.03508 33.0555 7.60759 25.7219 1.52787C25.3135 1.15738 24.6865 1.15738 24.278 1.52787C16.9444 7.60759 5.77295 8.03508 5.65896 8.03508C5.35497 8.05404 5.06048 8.19655 4.85146 8.42453C4.6425 8.66202 4.54747 8.96601 4.576 9.27951C4.576 9.27951 5.62092 21.3629 6.06743 26.3596C6.49492 31.2899 7.33088 40.4759 24.525 48.636C24.8195 48.788 25.1805 48.788 25.4749 48.636C42.6691 40.4759 43.505 31.2899 43.9325 26.3596C44.379 21.3629 45.4239 9.27951 45.4239 9.27951C45.4525 8.96601 45.3574 8.66202 45.1485 8.42453ZM39.2018 25.9417C38.8408 30.055 38.2613 36.8186 25 43.5728V6.89512C30.3197 10.3909 36.4754 11.8159 40.3892 12.3953C40.0377 16.3661 39.4963 22.6738 39.2018 25.9417Z" fill="url(#paint0_linear_122_30411)"/>
  <defs>
    <linearGradient id="paint0_linear_122_30411" x1="19.5202" y1="1.25" x2="31.65" y2="32.0433" gradientUnits="userSpaceOnUse">
      <stop stop-color="#F3F3F6"/>
      <stop offset="1" stop-color="#663DDE"/>
    </linearGradient>
  </defs>
